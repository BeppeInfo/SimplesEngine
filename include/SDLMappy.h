...
private:
	...
	uint32_t ANDTSize;		// taille du bloc ANDT (utilise par l'affichage des anims
								// dans DrawBG
	Uint32		colorkey;
...
public:
	...
	int 		LoadMap(/*CDXScreen * Screen ,*/ const char * Filename ,
						int left , int top , int width , int height );
	int			MapLoad (const char * mapname/*, RBDIRECTDRAW lpDD*/);
    ...
    SDL_bool    CreateParallax( const char * Filename );
